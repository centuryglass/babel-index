...
The one layer still untested is the canvas itself — see
[the testing section](docs/implementation-plan.md#3a-testing). Every push and
every pull request to `main` runs the suite on Node 20, 22 and 24
