...
# needs_inpainting) doesn't belong on it.
...
def default_alt_prompt(keywords: list[str]) -> str:
    ...
    return (
        ...
        "enough to ground the reader, e.g. \"a shelved library wall of "
        "leather-bound books\",  \"the bookcase full of colorful paperbacks\""
        ", etc. Spend your words instead on what makes THIS tile distinctive: "
        ...
        "the reader should be able to tell this is a shelved library wall and "
        "have some basic idea of what the shelf and books look like, even "
        ...
        "inform what you see. Keywords don't always strongly influence a "
        "generated image, so don't overstate their impact if they don't "
        "actually seem present in the image.\n\n"
