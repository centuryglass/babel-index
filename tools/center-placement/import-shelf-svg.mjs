 ...
 * geometry.
 *
 *   node tools/center-placement/import-shelf-svg.mjs <shelf_geometry.svg> [--out <file>]
 *
...
const outPath = resolve(
  process.cwd(),
  args.find((a) => a.startsWith('--out='))?.slice(6) ?? 'tools/center-placement/lib/measured.js'
);
 ...
 *
 * GENERATED by tools/center-placement/import-shelf-svg.mjs from ${basename(src)}.
