...
comparable. Changing the model here means changing it in
`packages/server/app.ts` too, then regenerating this blob; otherwise the
ranking compares vectors from two different spaces.
